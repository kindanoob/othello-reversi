...
Button::Button(const sf::Vector2f& rect_shape_size,
    ...
    //auto button_rect = RectShape().getGlobalBounds();
    ...
    //auto text_rect = ButtonText().getGlobalBounds();
    ...
    //button_text_.setPosition(rect_shape_position + 
                             //sf::Vector2f((button_rect.width - text_rect.width) / 2, (button_rect.height - text_rect.height) / 2));
